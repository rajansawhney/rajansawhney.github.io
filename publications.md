...
<table class="pub-table">
  <tr>
    <td class="pub-image">
      <img src="/assets/img/publications/viral_fine_tuning_2025.png" alt="Viral Fine-tuning">
      <img src="/assets/img/publications/viral_fine_tuning_alignment_2025.png" alt="Viral Fine-tuning">
    </td>
	<br>
...
<table class="pub-table">
  <tr>
    <td class="pub-image">
      <img src="/assets/img/publications/extending_plm_2025.png" alt="Extending-pLMs">
    </td>
	<br>
    <td class="pub-details">
...
<table class="pub-table">
  <tr>
    <td class="pub-image">
      <img src="/assets/img/publications/ml_apc_2022.png" alt="ML-APC">
    </td>
	<br>
    <td class="pub-details">
      <b>A machine learning platform to democratize ML modeling in ML-Advanced Process Control</b><br>
      Duo Zhang, Runshen Xu, Ali Ahmadi, Gobind Bisht, <u>Rajan Sawhney</u><br>
      <i>Advanced Process Control Smart Manufacturing Conference (APCSM)</i>, 2022<br><br>
      <a class="color-button" href="/papers/ml_apc_2022.pdf" target="_blank">PDF</a>
      <br><br>
      <!-- <img src="/assets/img/icons/altmetric.png" alt="Altmetric" style="height: 18px; vertical-align: middle;"> 30 &nbsp;
      <img src="/assets/img/icons/citations.png" alt="Citations" style="height: 18px; vertical-align: middle;"> 5 -->
    </td>
